...
repository:
  ...
  image:
    ...
    tag: \"feature-REPO-4002_upgrade_mariadb_2.2.5-6.2.0-SNAPSHOT\"
...
registryPullSecrets: quay-registry-secret" > acs_install_values.yaml
    ...
    helm install alfresco-incubator/alfresco-content-services --version 1.1.7 -f acs_install_values.yaml --name $ACS_RELEASE --namespace=$DESIREDNAMESPACE
